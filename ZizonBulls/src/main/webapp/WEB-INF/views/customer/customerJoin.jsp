			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="POST" action="customerInsert.do"
							class="register-form" id="register-form">
							<div class="form-group">
								<label for="cusId" class="cusIdLabel"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="cusId" id="cusId" placeholder="ID" /> <span
									class="result"> <span> <input type="button"
							...
							<div class="form-group">
								<label for="cusName"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="cusName" id="name" placeholder="Your Name" />
							</div>

							<div class="form-group" class="businessPhoneNumberCheckBox">
								<input type="checkbox" name="businessCheckBox"
									id="businessCheckBox" class="agree-term" /> <label
									for="businessCheckBox" class="label-agree-term"><span><span></span></span>Check
									if you are a business owner</label>
							</div>
							<div class="form-group" class="businessPhoneNumberToggle">
								<label for="busPhoneNum"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="busPhoneNum" id="busPhoneNum"
...
<!-- 							</div> -->
							<div class="form-group form-button">
								<input type="submit" name="signup" id="signup"
									...
									onclick="return submit_ok()" /> <input type="reset"
									name="reset" class="form-submit" value="Cancel" />
							</div>
						</form>
					...
					<div class="signup-image">
						<figure>
							<img src="../resources/customer/images/signup-image.jpg"
								alt="sign up image">
						</figure>
	...
	<script type="text/javascript">
		...
		function submit_ok() {
			...
			if ($('input[name="pass"]').val() != $('input[name="re_pass"]')
					.val()) {
				alert("비밀번호가 일치하지 않습니다.");
				return false;
			}
