        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="text-center">
                    <img src="${path }/resources/img/logo/로고10.png"  width="180" class="img-thumbnail logo img-circle">
<%--                     <img style="width: 170px; height: 60px;" src="${path }/resources/img/logo/로고10.png" alt="" /> --%>
                    <div>
