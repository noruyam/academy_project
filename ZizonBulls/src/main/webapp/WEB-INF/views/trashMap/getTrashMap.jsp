				...
				<div class="container">
					<div class="tokyo_tm_home">
						<div class="home_content">
							<div class="avatar">
								<div class="image" data-img-url="./resources/img/portfolio/1.jpg"></div>
							</div>
							<div class="details">
								<h3 class="name">Adriano <span>Smith</span></h3>
								<p class="job">Creative Photographer based in New York and happy to travel all over Europe to capture photos.</p>
								<div class="social">
									<ul>
										<li><a href="#"><img class="svg" src="./resources/img/svg/social/facebook.svg" alt="" /></a></li>
										<li><a href="#"><img class="svg" src="./resources/img/svg/social/twitter.svg" alt="" /></a></li>
										<li><a href="#"><img class="svg" src="./resources/img/svg/social/instagram.svg" alt="" /></a></li>
										<li><a href="#"><img class="svg" src="./resources/img/svg/social/dribbble.svg" alt="" /></a></li>
										<li><a href="#"><img class="svg" src="./resources/img/svg/social/tik-tok.svg"  alt="" /></a></li>
									</ul>
								</div>
							</div>
						</div>
									...
									<div class="inner">
										<div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Teresa Butler" data-category="Vimeo">
											<a class="popup-vimeo" href="https://vimeo.com/312334044">
												...
												<div class="main_image" data-img-url="./resources/img/portfolio/5.jpg"></div>
											</a>
										</div>
									</div>
								</li>
									...
									<div class="inner">
										<div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Ashley Flores" data-category="Youtube">
											<a class="popup-youtube" href="https://www.youtube.com/watch?v=Amq-qlqbjYA">
												<img src="./resources/img/thumbs/1-1.jpg" alt="" />
												<div class="main_image" data-img-url="./resources/img/portfolio/6.jpg"></div>
											</a>
										</div>
									</div>
								</li>
									...
									<div class="inner">
										<div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Derek Smith" data-category="Soundcloud">
											<a class="soundcloude_link mfp-iframe audio" href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/252739311&color=%23ff5500&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true">
												<img src="./resources/img/thumbs/1-1.jpg" alt="" />
												<div class="main_image" data-img-url="./resources/img/portfolio/4.jpg"></div>
											</a>
										</div>
									</div>
								</li>
								<li class="image">
									<div class="inner">
										<div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Gloria Jenkins" data-category="Image">
											<a class="zoom" href="./resources/img/portfolio/3.jpg">
												<img src="./resources/img/thumbs/1-1.jpg" alt="" />
												<div class="main_image" data-img-url="./resources/img/portfolio/3.jpg"></div>
											</a>
										</div>
									</div>
								</li>
									...
									<div class="inner">
										<div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Selena Gomez" data-category="Detail">
											<a class="popup_info" href="#">
												<img src="./resources/img/thumbs/1-1.jpg" alt="" />
												<div class="main_image" data-img-url="./resources/img/portfolio/7.jpg"></div>
											</a>
										</div>
									</div>
												...
												<ul>
													...
													<li>
														<div class="list_inner">
															<div class="my_image">
																<img src="./resources/img/thumbs/4-2.jpg" alt="" />
																<div class="main" data-img-url="./resources/img/portfolio/2.jpg"></div>
															</div>
														</div>
													</li>
													<li>
														<div class="list_inner">
															<div class="my_image">
																<img src="./resources/img/thumbs/4-2.jpg" alt="" />
																<div class="main" data-img-url="./resources/img/portfolio/3.jpg"></div>
															</div>
														</div>
													</li>
												</ul>
								...
								<li class="detail">
									<div class="inner">
										<div class="entry tokyo_tm_portfolio_animation_wrap" data-title="Ave Simone" data-category="Detail">
											<a class="popup_info" href="#">
												<img src="./resources/img/thumbs/1-1.jpg" alt="" />
												<div class="main_image" data-img-url="./resources/img/portfolio/8.jpg"></div>
											</a>
										</div>
									</div>
									<div class="details_all_wrap">
								...
								<div class="list_inner">
									...
									<div class="details">
										<div class="extra">
											...
											<div class="my_like">
												<a href="#"><img class="svg" src="./resources/img/svg/like.svg" alt="" /><span>35</span></a>
											</div>
										</div>
									...
									<div class="main_content">
										<div class="descriptions">
											...
											<div class="quotebox">
												<div class="icon">
													<img class="svg" src="./resources/img/svg/quote.svg" alt="" />
												</div>
								...
								<div class="list_inner">
									...
									<div class="details">
										<div class="extra">
											...
											<div class="my_like">
												<a href="#"><img class="svg" src="./resources/img/svg/like.svg" alt="" /><span>47</span></a>
											</div>
										</div>
								...
								<div class="list_inner">
									...
									<div class="details">
										<div class="extra">
											...
											<div class="my_like">
												<a href="#"><img class="svg" src="./resources/img/svg/like.svg" alt="" /><span>22</span></a>
											</div>
										</div>
								...
								<div class="list_inner">
									...
									<div class="details">
										<div class="extra">
											...
											<div class="my_like">
												<a href="#"><img class="svg" src="./resources/img/svg/like.svg" alt="" /><span>16</span></a>
											</div>
										</div>
